    ...
    <main className="bg-[#fafafa] min-h-screen py-12 px-4">
      <section className="text-center max-w-3xl mx-auto mb-12">
        <h1 className="text-4xl font-extrabold mb-4 text-indigo-600">
          Welcome to <span className="text-indigo-600">InkLink</span>
        </h1>
        <p className="text-gray-700 text-lg mb-6">
          InkLink is a beautiful place to express your emotions, thoughts, and stories.
          Read, write, and connect with souls who feel just like you.
        </p>
        <Link href="/create">
          <button className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-full text-lg font-semibold shadow-md transition">
            📓 ✨ Create a Blog
          </button>
        </Link>
      </section>
